      ...
      <Drawer.Portal>
        ...
        <Drawer.Content
          ...
          className={cn(
            ...
            "rounded-3xl bg-background dark:bg-panel-dark",
            className,
          )}
        >
          ...
          <div className="relative">
            ...
            <button
              onClick={close}
              className="absolute top-0 right-0 m-4 flex size-7 cursor-pointer items-center justify-center rounded-full bg-gray-200 text-gray-600 dark:bg-gray-700 dark:text-gray-300"
            >
              <TbX />
            </button>
