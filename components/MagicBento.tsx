...
const cardData: BentoCardProps[] = [
  { color: "#060010", content: <ProfileCard /> },
  { color: "#060010", content: <StatsCard /> },
  { color: "#060010", content: <Intro /> },
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  /* Both first cards equal width */
  .card-responsive .card:nth-child(1) { grid-column: span 1; }
  .card-responsive .card:nth-child(2) { grid-column: span 1; }

  /* Everything from card 3 onwards full width */
  .card-responsive .card:nth-child(n+3) { grid-column: span 2; }
}
        ...
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            ...
            const cardStyle = {
              ...
              color: "var(--white)",
              minHeight: card.minHeight || "200px",
              "--glow-x": "50%",
              "--glow-y": "50%",
              "--glow-intensity": "0",
              "--glow-radius": "200px",
